...
CustomerTrusted_node1758776312644 = glueContext.getSink(path="s3://abhi-bucket-2001/customer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerTrusted_node1758776312644")
CustomerTrusted_node1758776312644.setCatalogInfo(catalogDatabase="stedi2",catalogTableName="customer_trusted")
CustomerTrusted_node1758776312644.setFormat("json")
CustomerTrusted_node1758776312644.writeFrame(SQLQuery_node1758776260483)
job.commit()
